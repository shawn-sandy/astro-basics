...
- Automatically generate database migrations for PostgreSQL (Supabase)
...
**Run the migration to update your database** (see `scripts/migrations/README.md`):
...
3. Apply the generated migration with `psql` to update the database
...
# Apply database migration (use the number setup:roles printed)

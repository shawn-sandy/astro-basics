...
- Unified API in `src/libs/database.ts` via `getDatabase()`
...
```bash
# Create project at supabase.com, then run the wizard
npm run db:wizard
...
3. **Configure your database**: [02-guides/clerk-supabase-setup.md](./02-guides/clerk-supabase-setup.md)

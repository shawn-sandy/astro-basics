...
5. **Add a story** (React components): see **[Storybook](/guide/components/storybook/)**

### Previewing Components

React components are developed and documented in Storybook, which renders each one
in isolation with live prop controls and an accessibility audit:

```bash
npm run storybook
```

See **[Storybook](/guide/components/storybook/)** for the full guide.
...
- **[Storybook](/guide/components/storybook/)** - Interactive workshop for React components

...
You can also paste the migration file into the Supabase SQL editor.
...
3. Apply the generated migration with `psql "$DATABASE_URL" -f scripts/migrations/XXX_user_roles.sql`

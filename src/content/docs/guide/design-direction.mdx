...
default. Every pair clears WCAG 2.1 Level AA: in light, ink on paper is roughly 18:1, ink-soft on paper roughly 6.4:1
and island on paper roughly 6.7:1; in dark, every pair is 6.1:1 or better.

...
# Apply the Supabase migrations with psql (see scripts/migrations/README.md)
...
See the [Complete Setup Guide](/guide/getting-started/setup/) for detailed configuration.
...
# Apply the migration (use the number setup:roles printed)

...
- **Database Support**: Supabase (PostgreSQL) through a unified database abstraction layer
...
5. **[Database Troubleshooting](/guide/database-troubleshooting/)** - Diagnose Supabase connection issues

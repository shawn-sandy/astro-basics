...
For detailed setup instructions with screenshots, see the [Complete Setup Guide](/guide/getting-started/setup#option-b-manual-setup).
...
- [Database Troubleshooting](/guide/database-troubleshooting) - Diagnose Supabase configuration issues

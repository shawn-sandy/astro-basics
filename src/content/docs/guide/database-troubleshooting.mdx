...
**Symptoms:**
- `getDatabase()` throws "No database configured. Set SUPABASE_URL and SUPABASE_ANON_KEY in your environment variables."
...
<Tabs>
  <TabItem label="Quick Fix">
    <Steps>
      ...
      3. Follow the interactive prompts to enter your Supabase project URL, anon key, and (optionally) service role key
    </Steps>
  </TabItem>

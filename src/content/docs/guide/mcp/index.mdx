...
<CardGrid>
  ...
  <Card title="🎨 Figma" icon="paintbrush">
    **NEW!** Complete design-to-code generation, variable extraction, and asset management from Figma files. [Learn more →](/guide/mcp/servers/figma/)
  </Card>
...
<Tabs>
  ...
  <TabItem label="Development">
    ...
    - **NEW!** Generate production-ready code from Figma designs
    - **NEW!** Extract design tokens and sync with SCSS architecture
    - **NEW!** Export assets and create icon libraries from Figma
  </TabItem>

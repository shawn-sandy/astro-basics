...
<CardGrid>
  <Card title="🔧 Configuration Issues" icon="setting">
    **"Database not configured" error:**
    ...
    npm run db:wizard    # Run setup wizard
    ```
  </Card>
  <Card title="🔗 Connection Problems" icon="warning">
    **Connection failures during switching:**
    ```bash
    npm run db:manage test    # Test connections
    npm run db:manage health  # Run diagnostics
    ```
  </Card>
  ...
  <Card title="🚨 Emergency Recovery" icon="error">
    **Something went wrong:**
    ```bash
    npm run db:restore   # Rollback to previous config
    ```
  </Card>
</CardGrid>
